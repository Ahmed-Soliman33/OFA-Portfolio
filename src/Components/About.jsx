    ...
    <div className="m-auto mt-32 flex w-[80%] flex-col items-center gap-20 lg:flex-row">
      <div className="pb-20">
        <img
          ...
          src={saif_img}
          alt="Saif"
          loading="lazy" // تحسين تحميل الصورة
        />
      </div>
      <div className="max-w-[550px]">
        ...
        <p className="my-2 font-poppins text-[12px] font-light md:text-[16px]">
        ...
        <div className="my-3">
          ...
          <ul className="flex flex-wrap gap-2 px-2 pb-2">
            <li className="w-[70px]">
              <img src={after_effects} alt="After Effects" loading="lazy" />
            </li>
            <li className="w-[70px]">
              <img src={illustrator} alt="Illustrator" loading="lazy" />
            </li>
            <li className="w-[70px]">
              <img src={lightroom} alt="Lightroom" loading="lazy" />
            </li>
            <li className="w-[70px]">
              <img src={photoshop} alt="Photoshop" loading="lazy" />
            </li>
            <li className="w-[70px]">
              <img src={indesign} alt="InDesign" loading="lazy" />
            </li>
            <li className="w-[70px]">
              <img src={premiere} alt="Premiere Pro" loading="lazy" />
            </li>
          </ul>
        </div>
      </div>
